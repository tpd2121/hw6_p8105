...
We can see that in most city-states, male victim's cases have lower odds of being solved compared to female victim's (OR < 1). Only 3 city-states where male victim's cases have higher odds of being solved, which are Albuquerque (NM), Stockton (CA), and Fresno (CA); all of which has wide confidence interval. 
